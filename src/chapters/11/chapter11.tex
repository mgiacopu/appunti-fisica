...
\begin{equation} \label{flusso_superficie_finita}
    \Phi (E) = \int_{\Sigma} \overrightarrow{E} \cdot \overrightarrow{u}_n d \Sigma = \frac{q}{4 \pi \epsilon_0} \int d \Omega = \frac{q}{4 \pi \epsilon_0} \Omega 
\end{equation}
...
\begin{equation} \label{flusso_carica_interna}
    \Phi (E) = \frac{q}{4 \pi \epsilon_0} \oint d \Omega = \frac{q}{4 \pi \epsilon_0} 4 \pi = \frac{q}{\epsilon_0}
\end{equation}
...
\begin{equation*}
    d \Phi_1 (E) = \overrightarrow{E}_1 \cdot \overrightarrow{u}_n d \Sigma_1 = - \frac{q}{4 \pi \epsilon_0} d \Omega
\end{equation*}
\begin{equation*}
    d \Phi_2 (E) = \overrightarrow{E}_2 \cdot \overrightarrow{u}_n d \Sigma_2 = \frac{q}{4 \pi \epsilon_0} d \Omega = - d \Phi_1 (E)
\end{equation*}
\begin{equation*}
    \implies d \Phi_1 (E) + d \Phi_2 (E) = 0
\end{equation*}

Integrando su tutta la superficie ottengo:
\begin{equation} \label{flusso_carica_esterna}
    d \Phi_1 (E) = \oint \overrightarrow{E} \cdot \overrightarrow{u}_n d \Sigma
\end{equation}
...
\begin{equation*}
    \Phi (E) = \oint \overrightarrow{E} \cdot \overrightarrow{u}_n d \Sigma = \oint (\Sigma_i \overrightarrow{E}_i) \cdot \overrightarrow{u}_n d \Sigma = \Sigma_i \oint \overrightarrow{E}_i \cdot \overrightarrow{u}_n d \Sigma
\end{equation*}
...
\begin{equation} \label{flusso_cariche_puntiformi}
    \Phi (E) = \frac{1}{\epsilon_0} (\Sigma_i q_i)_{int}
\end{equation}
...
\begin{equation} \label{flusso_distribuzione_continua}
    \Phi (E) = \frac{1}{\epsilon_0} \int_{\tau} dq
\end{equation}
