...
La derivata di un versore \(\overrightarrow{u}\), in quanto vettore con modulo costante, si può scrivere \(\omega \times \overrightarrow{u}\) ; pertanto per le derivate dei tre versori \(\overrightarrow{u_{x'}},\overrightarrow{u_{y'}},\overrightarrow{u_{z'}}\), si hanno le seguenti formule, dette di Poisson:
\begin{equation}
...
\begin{equation}
    x' (\omega \times \overrightarrow{u_{x'}}) + y' (\omega \times \overrightarrow{u_{y'}}) + z' (\omega \times \overrightarrow{u_{z'}}) = \omega \times (x' \overrightarrow{u_{x'}} + y' \overrightarrow{u_{y'}} + z' \overrightarrow{u_{z'}}) = \omega \times \overrightarrow{r'}
\end{equation}
