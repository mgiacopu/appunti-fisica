...
caratteristiche di questo e la esprime con leggi \(\overrightarrow{\mathbf{r}}(t)\) quantitative.
...
sistema \emph{punto materiale} permette di definire nel modo più facile alcune
...
Un corpo esteso solo eccezionalmente si muove come un \emph{punto materiale},
spesso infatti può compiere contemporaneamente altri tipi di moto.

L'analisi completa del moto comprende:
\begin{itemize}
\item il collegamento del moto stesso alle interazioni del corpo con i corpi
  circostanti
\item la descrizione geometrica dell'evoluzione temporale del fenomeno di
  movimento.
\end{itemize}
...
\paragraph{Il moto}
Il \emph{moto} di un \emph{punto materiale} è determinato se è nota la sua posizione
...
riferimento dal quale si osserva il moto. Lo stesso \emph{punto materiale} può
...
velocità medie \(v_1, ..., v_n\).\\
Di solito queste velocità non sono
