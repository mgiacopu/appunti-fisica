...
% TODO: Riferimento a 9.1 corretto? ^^
...
Le (\ref{primo_principio_trasf_ideali}) sono un esempio di quando si possono esprimere i termini di (10.5) in funzione delle coordinate termodinamiche, ottenendo una relazione tra queste che rappresenta l'equazione della trasformazione. % TODO: 10.5 riferimento corretto?
...
Dall'equazione di stato o da (11.4) abbiamo che in una trasformazione isobara % TODO: Riferimento 11.4 corretto?
\begin{equation*}
...
% TODO Federico 10/05: Non trovo ref da parte di Iuppa su questo argomento
