...
\begin{itemize}
    \item equilibrio meccanico, inteso come equilibrio di forze e momenti, secondo quanto studiato in meccanica; 
    \item equilibrio chimico: non avvengono reazioni chimiche o trasferimenti di un componente del sistema entro il sistema stesso; 
    \item equilibrio termico: la temperatura è la stessa ovunque.
\end{itemize}
