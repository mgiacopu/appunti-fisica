...
% TODO check generale documento
% TODO sistemare notazione versori (u_x vs \hat{x})
% TODO fare (eventualmente) riassunto finale come cap1
...
\begin{equation}
    \overrightarrow{F} = m \frac{\overrightarrow{v}}{dt} = m \frac{d^2 \overrightarrow{r}}{dt^2} \ \udm{N} % TODO: Mazzoldi pag.35 -> cosa è r?
\end{equation}
...
\begin{equation}
    \overrightarrow{F_{el}} = -k x \hat{x} \udm{N}
\end{equation}
