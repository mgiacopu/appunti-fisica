...
% TODO: Salto il primo esempio, in caso si aggiunge più avanti. Passo al secondo che ha fatto Iuppa

\subsection{Esempio carrello}
% TODO aggiungi foto secondo esempio (carrello)
...
Si assuma l'attrito nullo e che ad un estremo del carrello ci sia una molla di costante elastica \(k\) (figura ??). % TODO add reference
